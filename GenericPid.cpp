...
//Função que realiza a computação do pid (ValorDeObjetivo - ValorAtual)
/*
	...
	meu objetivo é que a linha esteja sobre o S2, ou seja, meu ValorDeObjetivo = 2

	caso a linha esteja sobre o S3 o meu erro será de (2 - 3 = -1), ou seja preciso passar -1 como meu erro
*/
